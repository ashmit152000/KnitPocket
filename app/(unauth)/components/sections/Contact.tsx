            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
                <div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-gray-300">support@cashfactor.io</span>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10">
                            ...
                            <span className="text-gray-300">@cashfactor_app</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="glass-panel p-8 rounded-2xl border border-white/5">
                    <form className="space-y-4">
                        ...
                        <button type="button" className="w-full py-3 rounded-xl bg-gradient-to-r from-[#00D9FF] to-[#C77DFF] hover:from-[#00D9FF] hover:to-[#C77DFF] text-white font-bold transition-all">Send Message</button>
                    </form>
                </div>
            </div>
        </div>
